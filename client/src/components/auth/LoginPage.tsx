        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="space-y-3">
              ...
              >
                <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
                  <path fill="#6001D2" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm3.61 5.5L12.5 13h2.11v3.5h-2.11v2H10.5v-2H8.39V13h2.11l-3.11-5.5h2.22L12 11.17 14.39 7.5h2.22z"/>
                </svg>
                Continue with Yahoo
              </Button>
            </div>
